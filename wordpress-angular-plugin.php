<?php
/**
 * Plugin Name: Cotizador Cooperativa Salcaja
 * Description: Este es un complemento para el sitio web.
 * Author: Xelaweb
 * Version: 0.0.1
 * Author URI: 	https://www.xelaweb.com/
*/

 /*register and create new tables within the database  */
	...
	function booking_install() {
    	...
    	if ( $installed_version !== $booking_db_version ) {
        	// Create table for CREDITO 
        	$packagetable = $tableprefix . 'cotizador';
        	$sql = "CREATE TABLE " . $packagetable . " (
				...
				destiono_credito TEXT NOT NULL,
	        	garantia_credito TEXT NOT NULL,
				plazo INT NOT NULL,
				moneda text NOT NULL,
				monto DECIMAL(10,2) NOT NULL,
				porcen_aplicado DECIMAL(10,2) NOT NULL,
...
{	
	...
	public function __construct() {
		...
		$this->base_href = '/cotizador/'; // Matches /wordpress-angular-plugin/
